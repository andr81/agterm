...
- **Restore running commands on restart** turned on under Settings ▸ General ▸ Sessions. Without it a restarted agterm brings the tab back as a plain shell and the reconnect above does not happen.
